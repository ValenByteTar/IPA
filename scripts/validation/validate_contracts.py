...
Usage:
    python scripts/validation/validate_contracts.py outputs/manifests/processing.jsonl
    python scripts/validation/validate_contracts.py outputs/manifests/processing.jsonl --integrity
"""
