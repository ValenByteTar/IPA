...
Usage:
    python scripts/validation/validate_experiment_report.py path/to/report.json
"""
...
SCHEMA_PATH = Path(__file__).resolve().parents[2] / "contracts" / "experiment_report.schema.json"
