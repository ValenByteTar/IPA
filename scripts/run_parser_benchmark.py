...
Usage:
    ...
    python scripts/run_parser_benchmark.py --pdfs Landing --output outputs/experiments/E3 --limit 20

    # E5: chunking competition on extracted text
    python scripts/run_parser_benchmark.py --store outputs/experiments/E1-corpus/document_store.db --output outputs/experiments/E5 --limit-docs 50
"""
