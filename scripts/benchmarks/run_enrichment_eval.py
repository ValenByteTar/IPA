"""Run E9 â€” Semantic enrichment with 3 strategies in parallel.
...
Usage:
    python scripts/benchmarks/run_enrichment_eval.py
...
def main() -> None:
    ...
    from ipa.enrichment.enrichment import STRATEGIES
