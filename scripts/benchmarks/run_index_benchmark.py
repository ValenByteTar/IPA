...
Usage:
    ...
    python scripts/benchmarks/run_index_benchmark.py --store outputs/experiments/E1-corpus/document_store.db --output outputs/experiments/E6 --mode lexical

    # E7: vector competition (LanceDB vs sqlite-vec)
    python scripts/benchmarks/run_index_benchmark.py --store outputs/experiments/E1-corpus/document_store.db --output outputs/experiments/E7 --mode vector
"""
