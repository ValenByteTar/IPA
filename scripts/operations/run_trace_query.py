"""E11 â€” Observability: query and display artifact traces.

Usage:
    python scripts/operations/run_trace_query.py --trace-db outputs/experiments/E11-observability/trace.db
    python scripts/operations/run_trace_query.py --trace-db trace.db --artifact sha256:abc123
    python scripts/operations/run_trace_query.py --trace-db trace.db --summary
    python scripts/operations/run_trace_query.py --trace-db trace.db --failed
"""
...
from ipa.observability.trace_log import TraceLog
