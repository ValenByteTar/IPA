"""Run E9 — Selective enrichment experiment on 2000 chunks.

Full pipeline:
  Phase 1: Sample 2000 chunks (excluding pure noise)
  Phase 2: Generate 2000 natural language queries with LLM (3 workers)
  Phase 3: Enrich 2000 chunks × 3 strategies = 6000 LLM calls (3 workers each)
...
Usage:
    python scripts/run_enrichment_experiment.py
...
def main() -> None:
    ...
    from ipa.enrichment import STRATEGIES, generate_nl_query
